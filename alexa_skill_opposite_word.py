...
# OppositeWord
# By Dr Faruque Sarker <fsarker@vursoft.co.uk>
#
# An Alexa Skill that will tell you the opposite of any word you tell her
...
__author__ = 'Dr Faruque Sarker'
__email__ = 'fsarker@vursoft.co.uk'
...
def handle_launch():
    ...
    * Card body: 'welcome_card'
    ...
    return question(welcome_text).reprompt(welcome_re_text).standard_card(title="OppositeWord",
